...
{ 
    ...
    sort(arr.begin(),arr.end());   //finding the largest element in  the vector by sort in sorting in acsending order.
    cout<<arr[n-1]<<endl; 
    ...
    /*
    int maxi =*max_element(arr.begin(),arr.end());   //finding the largest element in  the vector
    cout<< maxi;
    */
}
